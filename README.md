...
- Allows staff to toggle staff-chat mode, sending only staff messages when typing in chat (Needs to be toggled off again to send regular messages)

> /evesstaffchat reload
- Allows the config(s) to be reloaded if needed
